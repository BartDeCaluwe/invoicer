defmodule InvoicerWeb.Errors do
  alias Ecto.Changeset
  alias InvoicerWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(Invoicer.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(Invoicer.Gettext, "errors", message, options)
    end
  end
